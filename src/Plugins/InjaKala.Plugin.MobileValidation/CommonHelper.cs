...
{
    internal partial class CommonHelper
    {
        #region Fields
        ...
        {
            var arr = new string[length + 1];
            var minValueStr = int.Parse($"1{string.Join("0", arr.Skip(1))}");
            var maxValueStr = int.Parse(string.Join("9", arr));
            return new Random().Next(minValueStr, maxValueStr);
        }
