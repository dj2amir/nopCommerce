...
public class OTPMethod : BasePlugin, IMultiFactorAuthenticationMethod, IAdminMenuPlugin
{
    ...
    public override async Task InstallAsync()
    {
        ...
        await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
        {
            ...
            // Admin configuration
            ["Plugins.MultiFactorAuth.OTP.Fields.SmsProviderApiKey"] = "کلید API سرویس پیامک (X-API-KEY)",
            ["Plugins.MultiFactorAuth.OTP.Fields.SmsProviderApiKey.Hint"] = "کلید API (X-API-KEY) دریافت شده از سرویس SMS.ir را وارد کنید",
            ["Plugins.MultiFactorAuth.OTP.Fields.SmsProviderSecretKey"] = "کلید مخفی سرویس پیامک (منسوخ شده)",
            ["Plugins.MultiFactorAuth.OTP.Fields.SmsProviderSecretKey.Hint"] = "این فیلد با API جدید SMS.ir استفاده نمی‌شود و اختیاری است",
            ["Plugins.MultiFactorAuth.OTP.Fields.SmsProviderBaseUrl"] = "آدرس پایه سرویس پیامک",
            ["Plugins.MultiFactorAuth.OTP.Fields.SmsProviderBaseUrl.Hint"] = "آدرس پایه API سرویس پیامک (پیش‌فرض: https://api.sms.ir)",
            ["Plugins.MultiFactorAuth.OTP.Fields.SmsTemplateId"] = "شناسه قالب پیامک",
            ["Plugins.MultiFactorAuth.OTP.Fields.SmsTemplateId.Hint"] = "شناسه قالب پیامک که در پنل SMS.ir تعریف شده است",
            ["Plugins.MultiFactorAuth.OTP.Fields.SenderNumber"] = "شماره فرستنده",
            ["Plugins.MultiFactorAuth.OTP.Fields.SenderNumber.Hint"] = "شماره فرستنده پیامک (اختیاری)",
            ...
            ["Plugins.MultiFactorAuth.OTP.Fields.SmsProviderSecretKey.Required"] = "کلید مخفی سرویس پیامک الزامی است (منسوخ شده - اختیاری)",
